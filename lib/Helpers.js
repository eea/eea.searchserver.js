function SimpleStart(settings){
  ...
  app.put('/setlandingvalue', function(req, res) {settings.routes.routes.setlandingvalue(req, res)});
  app.put('/invalidatelandingvalues', function(req, res) {settings.routes.routes.invalidatelandingvalue(req, res)});
