...
/*    app.get('/invalidate_templates', routes.invalidateTemplates);
    ...
    if (lv.url_folder){
      app.get(path.join(lv.url_folder,'tools/api'), routes.elasticProxy);
      app.post(path.join(lv.url_folder,'tools/api'), routes.elasticProxy);
      app.use(lv.url_folder, express.static(path.join(__dirname, 'public')));
      app.use(path.join(lv.url_folder,"esbootstrap_resources"), express.static(path.join(__dirname, 'public')));
      app.get(path.join(lv.url_folder,'/tools/download'), routes.download);
    }
