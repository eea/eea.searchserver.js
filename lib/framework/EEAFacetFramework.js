...
function render(req, res, template, options, isDetail) {
  ...
  var landingtemplate = path.join('/code/config/', APP_CONFIG_DIR,  "landing.jade");
                        ...
                        getDisplayOptionsFromSettings(function(settings_display_options){
                            getDefaultDisplayFromSettings(function(settings_default_display){
                                middleware.templateRequired(req, res, function(){
                                    ...
                                    var enableCardTemplate = true;
                                    if (enableCardTemplate){
                                        var cardTemplateStr = fs.readFileSync(path.join(__dirname, 'views', 'cardview.jade'));
                                        templatestr = templatestr + cardTemplateStr;
                                    }

                                    var enableListTemplate = true;
                                    if (enableListTemplate){
                                        var listTemplateStr = fs.readFileSync(path.join(__dirname, 'views', 'listview.jade'));
                                        templatestr = templatestr + listTemplateStr;
                                    }
