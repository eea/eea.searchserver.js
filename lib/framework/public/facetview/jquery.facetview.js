...
*/
        ...
        var addRadioOptions = function(facet, tree) {
            tree.find(".jstree-anchor").append('<span class="eea-tree-radiobutton ui-icon ui-icon-radio-off"></span>');
            var selected = $("#facetview_group_" + facet).find(".facetview_filterselected").attr("href") || "All";
            tree.find("[title='" + selected + "']").find(".eea-tree-radiobutton").removeClass("ui-icon-radio-off").addClass("ui-icon-radio-on");
        }
...
/*                    if ( options.enable_rangeselect ) {
        ...
        $.fn.facetview.clickfilterchoice = function(event, rel, href, initiator) {
            ...
            if ($.inArray(rel, options.aggregation_options) !== -1){
                ...
                tree.find(".eea-tree-radiobutton").removeClass("ui-icon-radio-on").addClass("ui-icon-radio-off");
                tree.find(".facetview_filterchoice[title='"+href+"']").find(".eea-tree-radiobutton").removeClass("ui-icon-radio-off").addClass("ui-icon-radio-on");
            }
        ...
        var elasticsearchquery = function() {
            ...
            $('.facetview_filterselected', obj).each(function() {
                ...
                if ($.inArray(facetname, options.aggregation_options) !== -1){
                    //return; //TODO implement the range
                    isAggregation = true;
                }
