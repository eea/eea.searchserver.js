...
//                setfilterdescription(id, 'all');
        ...
        var createfacetgeo = function (options){
            ...
            var geoselect = [
                ...
                '<div class="clearfix">',
                    '<div class="btn-group facetview_geo_options" id="facet_geo_options_'+rel+'" >',
                        '<button id="switch_entire_'+rel+'" type="button" class="btn btn-default map-selection-switcher-'+rel+'">',
                            'Entire map <i class="icon-ok" style="display: none;"></i>',
                        '</button>',
                        '<button id="switch_distance_'+rel+'" type="button" class="btn btn-default map-selection-switcher-'+rel+'">',
                            'Distance area <i class="icon-ok" style="display: none;"></i>',
                        '</button>',
                        '<button id="switch_bounding_'+rel+'" type="button" class="btn btn-default map-selection-switcher-'+rel+'">',
                            'Bounding area <i class="icon-ok" style="display: none;"></i>',
                        '</button>',
            ...
            if(gmaps_loaded) {
                ...
                $('#switch_entire_' + rel).click(function() {
                    geotype = $('#facetview_geoplaceholder_' + rel, obj).find(".facetview_geo_type_"+rel).attr("value");
                ...
                $("#facetview_geoplaceholder_" + rel + " input", obj).change(function(){
                    if ($('#distance_fields_' + rel).hasClass('ui-state-active')) {
                        $('#switch_distance_' + rel).click();
                    }
                    if ($('#bounding_fields_' + rel).hasClass('ui-state-active')) {
                        $('#switch_bounding_' + rel).click();
                    }
                });
...
//                setfilterdescription("facetview_group_" + relclean, op_text);
        ...
        var addValuesToTree = function(orRel, facetName, tree, records, order, doptions) {
            tree.data("values_count", Object.keys(records).length);
