...
*/
        ...
        function fillMissingValues(set, step, intervalInput, sliderInterval, groupedDataset) {
            ...
            if(result[result.length-1] !== intervalRangeEnd.toFixed(dec) ){
                result.push(parseFloat(intervalRangeEnd.toFixed(dec)));
            }
        ...
        function renderHistogram(rel, dataset, intervalInput, event, sliderInterval) {
            ...
            var bW = width  /  datasetLength ;
            var barW = Math.round(bW - 2*padding);
            ...
            svg.selectAll("rect")
                ...
                .append("rect")
                    ...
                    .attr("x", function(d, i) {
                        return i * ((width / datasetLength-1) + padding);
                    })
                    ...
                    .attr("width", function(a, i){
                        return width / datasetLength-1 - padding;
                    })
