...
/* disable global exact search
        ...
        thefacetview += '<a class="eea-icon eea-icon-file-excel-o eea_download_btn eea_custom_btn i18n" download_type="csv" href="tools/download" i18n-variable="Search_Download_CSV_Link_Text" i18n-change="html"><span>Download CSV</span></a>';
        thefacetview += '</div>';
        thefacetview += '<div class="facetview_metadata">';
