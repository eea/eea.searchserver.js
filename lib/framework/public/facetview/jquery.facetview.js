...
*/
        ...
        function renderSliderHistogram(rel, event, step, dataset, groupedDataset, intervalInput, sliderInterval, histogram_config,
            ...
            if(rel == 7){
                console.log("################################################");
                if(fromRefresh === undefined) fromR = false;
                console.log("rel: " + rel);
                console.log("fromR: event :" + fromRefresh, event);
                console.log("fromR: step :" + fromRefresh, step);
                console.log("fromR: dataset :" + fromRefresh, dataset.length);
                console.log("fromR: groupedDataset :" + fromRefresh, groupedDataset.length);
                console.log("################################################");
            }
