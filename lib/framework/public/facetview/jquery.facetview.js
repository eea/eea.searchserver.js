        ...
        var facetrangehistogram = function(event) {
            ...
            function startGoogleChart(elemId, dataFromFacet, facetOptions){
                ...
                function drawChart() {
                    ...
                    dataFromFacet.forEach(function(curr,index){
                    ...
                    //chart = new google.visualization.ColumnChart(document.getElementById(elemId));
                    gchart = wrapper;
                    ...
                    function parseRangeHistogramFacetValues(sdata){
                        ...
                        for ( var item in data.facets[tmp_facet] ) {
                            if (!isNaN(item)){
                                ...
                                //console.log( item + " => " + data.facets[tmp_facet][item] );
