...
//        thefacetview += '<a class="eea_download_btn eea_download_stripe i18n" download_type="tsv" href="tools/download" i18n-variable="Search_Download_TSV_Link_Text" i18n-change="html">Download TSV</a>';
//        else {
            thefacetview += '<a class="eea-icon eea-icon-file-excel-o eea_download_btn i18n" download_type="csv" href="tools/download" i18n-variable="Search_Download_CSV_Link_Text" i18n-change="html">Download CSV</a>';
//        }
        thefacetview += '</div>';
