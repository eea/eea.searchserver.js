...
*/
        ...
        function fillMissingValuesWithExtremes(intervalInput, sliderInterval, groupedDataset, histogram_config){
            ...
            if(sliderRatio > 1){
                ...
                minArrG.push( (datasetG[0] - minArrG[minArrG.length-1])/2 );
                //minArrG = minArrG.concat( (datasetG[0] - minArrG[minArrG.length-1])/2 );
        ...
        function renderHistogram(rel, dataset, intervalInput, event, sliderInterval) {
            ...
            var sliderWidth = $( "#facetview_slider_" + rel).width();
            ...
            //var colWidth = Math.floor(sliderWidth / datasetLength);
            ...
            svg.selectAll("rect")
                ...
                .append("rect")
                    .attr("x", function(d, i) {
                        //console.log(Math.floor( i * colWidth ));
                        if(datasetLength % 2 === 0){
                            return Math.floor(i * (colWidth ) + 4) + 2 ;
                        }
                        return i * colWidth + 4;
                    })
        ...
        function renderSliderHistogram(rel, event, step, dataset, groupedDataset, intervalInput, sliderInterval, histogram_config) {
            ...
            if( histogram_config.slider_bucket_min || histogram_config.slider_bucket_max
                || histogram_config.columns_bucket_min || histogram_config.columns_bucket_max ){
