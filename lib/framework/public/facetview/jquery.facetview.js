...
$(document).ready(function($){
    ...
    window.onpopstate = function(event) {
        ...
        var url_filters = url_function_score.filter.and;
        var url_queries = url_function_score.query.bool.must;
        var function_score = last_qry_vars.query.function_score;
        var filters = function_score.filter.and;
        var queries = function_score.query.bool.must;
        var filter;
        var key;
        var obj;
        var $header;
        ...
        if (url_queries.length !== queries.length) {
