...
*/
        ...
        function groupDatasetByIntervalWithExtremes(set, intervalInput, histogram_config) {
            ...
            var resultT = groupDatasetByInterval(dataset, intervalInput);

            var result = resultT.map(function(item, index, arr){
                if (item.x !== undefined) {
            ...
            var tempR =  minArrRes.concat(result).concat(maxArrRes);
            var res = tempR.map(function(item, index, arr){
