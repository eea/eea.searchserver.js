...
function customSetUrl(options, stateObj, page, url){
    var default_language = window.settings_default_language;
    var languages = window.settings_languages;
    var query = {};
    var newUrl = {};
...
(function($) {
    ...
    $.fn.facetview = function(options) {
        ...
        // check url_options, if it only has a 'q' paramater, handle it as an initial search, and apply all default settings
        if ((url_options.q !== undefined) && (Object.keys(url_options).length === 1)){
            options.isInitialSearch = true;
        }
        ...
        var getJson = function(value, property, rel) {
            ...
            if (typeof value === 'string') {
                jsonval.push(
                    {
                        'text': '<span class="facet_label_count">' + count + '</span><span class="facet_label_text 1">' + value + '</span>',
                        'li_attr' : {
                            'rel' : property,
            ...
            for (var element in value) {
                ...
                if (children.length > 0) {
                    jsonval.push({
                        'text': '<span class="facet_label_count">' + count + '</span><span class="facet_label_text 2">' + value + '</span>',
                        'state': {
                            'opened' : true,
                            'selected' : false
                        },
...
*/
            ...
            if ((jQuery.inArray(facet, options.rangefacets) !== -1) || (jQuery.inArray(facet, options.rangehistogramfacets) !== -1)){
                ...
                if (jQuery.inArray(facet, options.aggregation_options) !== -1){
                    ...
                    if (values.length > 0){
                        ...
                        var option_all = {
                            text: "<span class='facet_label_count'>" + vals_total + "</span><span class='facet_label_text i18n' i18n-variabile='App_Word(All)' i18n-change='html'>All</span>",
                            li_attr:{
        ...
        var dofacetrange = function(rel, use_html_values) {
            ...
            var myobj = '<div class="facetview_selection 3"> <a ' +
...
*/
                ...
                options.source || options.initialsearch ? dosearch(options) : '';
