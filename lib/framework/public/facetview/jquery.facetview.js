...
function checkLandingPage(options) {
    ...
    if (isLanding) {
        console.log('I. Is landing: ', isLanding)
        ...
        console.log('II. Is landing: ', isLanding)
...
//                var set_max_I = set_max + intervalInput;
        ...
        function facetRangeHistogram(event,  step) {
            ...
            var datasetGroupByInterval1 = formatRecords(valsobj.data().records, histogram_config);
//xxx
            var datasetFilledMissing = []
            var datasetGroupByInterval = formatRecords(valsobj.data("group_values"), histogram_config);
