                ...
                if (or_button_rel === 'OR') {
                    ...
                    if ((!filters)||(!filters.filter)) {
                        ...
                        if ('bool' in filters || 'and' in filters) {
                            ...
                            newQuery = {'query':{}};
                            newQuery.query[options.query_type] = {'must': tmp_newQuery.query, 'filter': filters};
                        ...
                        $.each(d.aggregations, function(f_key, f_opts){
                            if (f_opts.buckets.length > 0){
                                ...
                                while (true){
                                    ...
                                    var tmp_val = f_opts.buckets[first_cnt].key;
                                    if (parseFloat(tmp_val).toString() === tmp_val){
                                ...
                                while (true){
                                    ...
                                    var tmp_val = f_opts.buckets[last_cnt].key;
                                    if (parseFloat(tmp_val).toString() === tmp_val){
