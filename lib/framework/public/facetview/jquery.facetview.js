...
*/
        ...
        function groupDatasetByIntervalWithExtremes(set, intervalInput, histogram_config, fromRefresh) {
            ...
            var resultT = groupDatasetByInterval(dataset, intervalInput, set_min, set_max, fromRefresh);
...
/*            if (Object.keys(filteredRecords).length > fn_settings.size){
        ...
        var refreshHistogram = function(data, el, rel){
            ...
            var datasetGroupByInterval = groupDatasetByIntervalWithExtremes(filterDataset, intervalInput,
                histogram_config, true);

            var datasetGroupByIntervalOLD = groupDatasetByIntervalWithExtremes(datasetFilledMissing, intervalInput,
                histogram_config);
            ...
            if(histogram_config.histogram === undefined || histogram_config.histogram !== false  ){
                setTimeout(function(){
                    // used setTimout to allow DOM to create the slider
                    // we need it to determine the width of the histogram
                    renderHistogram(rel, datasetGroupByIntervalOLD, intervalInput, target, sliderInterval, true);
