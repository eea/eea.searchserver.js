...
/*                    if ( options.enable_rangeselect ) {
            ...
            for (var prop in options.hierarchy) {
                ...
                autocomplete_input.autocomplete({source:function(request, response){
...
//                setfilterdescription("facetview_group_" + relclean, op_text);
        ...
        var sortedFacetValuesKeys = function(records) {
            return keys = Object.keys(records).sort(function(a,b){
        ...
        var addValuesToTree = function(fn_options) {
            ...
            fn_settings.tree.data("records", filteredRecords);
