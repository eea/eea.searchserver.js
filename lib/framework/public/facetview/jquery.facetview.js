...
*/
        ...
        function fillMissingValues(set, step, intervalInput, sliderInterval) {
           var result = [];

            var intervalRangeStart = Math.floor( set[0] / intervalInput) * intervalInput;
            var intervalRangeEnd = Math.floor( ( set[ set.length-1 ] / intervalInput) * intervalInput);

            for (var i = intervalRangeStart; i <= intervalRangeEnd; i += sliderInterval) {
                result.push(i);
            }
            return result;
        }
        ...
        function renderSliderHistogram(rel, event, step, dataset, groupedDataset, intervalInput, sliderInterval) {
            ...
            var values = fillMissingValues(valsobj.data("values"), step, intervalInput, sliderInterval);
