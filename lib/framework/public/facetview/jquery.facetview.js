...
/*                    if ( options.enable_rangeselect ) {
    ...
    //                setfilterdescription("facetview_group_" + relclean, op_text);
        ...
        function parseExplanation(explanation){
            ...
            settings_relevance.fields_boosting.fields.forEach(function(field){
            ...
            settings_relevance.functions.forEach(function(fct){
            ...
            if (settings_relevance_enabled){
                if (!$.isEmptyObject(options.relevance)){
                    if (options.relevance.functions !== undefined){
                        options.relevance.functions.forEach(function(value) {
