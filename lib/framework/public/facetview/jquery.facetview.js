                ...
                '<div class="clearfix">',
                    '<div id="geo-facet-tabs_' + rel +'">',
                        ...
                        '<div id="geo-distance-tab">',
                            ...
                            '<button class="facetview_dist_map_'+rel+'">Open map</button><br/>',
                        '</div>',
                        '<div id="geo-bounding-box-tab">',
                            ...
                            '<button class="facetview_bound_map_'+rel+'">Open map</button><br/>',
                        '</div>',
            ...
            if(gmaps_loaded) {
                ...
                $("#dialog_dist_" + rel).dialog({
                    ...
                    open: function( event, ui ) {
                        ...
                        map_dist = new google.maps.Map($('#map_dist_' + rel)[0], {
                    ...
                    close: function( event, ui ) {
                        ...
                        map_dist = undefined;
                        circle_dist = undefined;

                        $("#facetview_geoplaceholder_" + rel + " input", obj).trigger( "change" );
                    },
                    buttons: [
                        {
                          text: "OK",
                ...
                $("#dialog_bound_" + rel).dialog({
                    ...
                    open: function( event, ui ) {
                        ...
                        map_bound = new google.maps.Map($('#map_bound_' + rel)[0], {
                            center: {lat: 48.738525, lng: 13.981955},
                            zoom: 5
                        });
                ...
                $(".facetview_dist_map_" + rel).hide();
                $( "#dialog_dist_" + rel).hide();
                $(".facetview_bound_map_" + rel).hide();
                $( "#dialog_bound_" + rel).hide();
            }
