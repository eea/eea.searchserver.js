...
*/
        ...
        var selectFromAutocomplete = function(rel, title){
...
/*                    if ( options.enable_rangeselect ) {
                ...
                if (autocomplete){
                    autocomplete_html = '<div class="facetview_filter_typeahead"><span>Search for value</span><input type="text" rel="' + prop +  '"/></div>';
                }
                var exact_helper_class = '';
            ...
            for (var prop in options.hierarchy) {
                ...
                autocomplete_input.autocompleteForFacet(
                    ...
                    select:function(event, ui){
                        selectFromAutocomplete(ui.item.rel, ui.item.term);
                    }
                });
            }
