...
*/
        ...
        var facetrangehistogram = function(event) {
            ...
            var rangeselect = [
                ...
                rel,
                '">' ,
                '<div id="facetview_rangehistogramplaceholder_container'+ rel +'" class="facetview_facetrange_histogram" ><div id="facetview_rangehistogramplaceholder"',
                rel,
                ' ></div></div>',
                '</div> </div>'
            ].join('');
            ...
            function startGoogleChart(elemId, dataFromFacet, facetOptions){
                ...
                function drawChart() {
                    ...
                    var $elem = $("#" + elemId);
                    var charW = $elem.width();
                    var charH = $elem.height();
                    ...
                    var charOptions =  {
                        title: "",
                        width: $elem.width(),
                        height: facetChartOptions.height || 40,
                        bar: {groupWidth: "100%"},
                        legend: { position: "none" },
                        chartArea : { width: charW , backgroundColor: { stroke: '#fff'}},
                        hAxis : { logScale: true, baselineColor: '#fff'},
            ...
            startGoogleChart('facetview_rangehistogramplaceholder_container'+ rel, valsobj.data("group_values"), facetOptions);
