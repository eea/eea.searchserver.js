...
$(document).ready(function($){
    ...
    window.onpopstate = function(event) {
        ...
        var url_filters = url_function_score.filter.and || url_function_score.filter.must;
        ...
        var filters = function_score.filter.and || function_score.filter.must;
        ...
        // exact change
        if (url_function_score.functions.length - function_score.functions.length !== 0) {
            // todo
        }
