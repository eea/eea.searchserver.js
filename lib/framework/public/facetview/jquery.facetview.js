            ...
            svg.selectAll("rect")
                ...
                .append("rect")
                    ...
                    .on("mouseover", function(d, i) {
                        ...
                        .classed('hidden', false)
                        .style("left", function() {
                            //return ( $(d3.event.relatedTarget).offset().left + d3.event.offsetX - $(this).width()) + "px";
                            //return ($(d3.event.relatedTarget).position().left + d3.event.offsetX ) + "px";
                            //console.log(d, i);

                            //return (i * (d3.event.pageX - $(d3.event.relatedTarget).offset().left) - $(this).width() ) + "px";
                            /*console.log("##############################################################");
                            console.log("i: " + i);
                            console.log("d3.event.pageX: " + d3.event.pageX);
                            console.log("$(d3.event.relatedTarget).offset().left :" + $(d3.event.relatedTarget).offset().left);
