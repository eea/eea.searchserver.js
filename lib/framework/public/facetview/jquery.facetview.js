                ...
                change: function( event, ui ) {
                    ...
                    if(!detachedSlider){
                        ...
                        if (ui.handle.nextSibling) {
                            ...
                            // Moving LEFT slider ...
                            setTimeout(function(){
                                dofacetrangeHistogram( rel,true, histogram_config, {min: values[ ui.values[0] ] , max: parseFloat(highrangeInput.val()) } );
                            }, 500);
                        } else {
                            // Moving RIGHT slider ...
                            lowrangeText.html(lowrangeInput.val());
                            setTimeout(function(){
                                dofacetrangeHistogram( rel,true, histogram_config, {min: parseFloat(lowrangeInput.val()), max: values[ui.values[1]] }  );
                            }, 500);
                        }
