...
//        else {
            thefacetview += '<a class="eea_download_btn i18n" download_type="csv" href="tools/download" i18n-variable="Search_Download_CSV_Link_Text" i18n-change="html">Download CSV</a>';
//        }
        thefacetview += '</div>';
