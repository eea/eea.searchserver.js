...
//                        chartType: 'ColumnChart',
                        title: "",
                        width: charW,
                        height: facetChartOptions.height || 400,
                        bar: {groupWidth: "50%"},
                        legend: { position: "none" },
                        chartArea : { width: charW , height: facetChartOptions.height || 400, backgroundColor: { stroke: '#fff'}},
//                        hAxis : { logScale: true, baselineColor: '#fff', color:'#fff', gridlineColor: '#fff'},
//                        vAxis: { gridlines: {color: "#fff"}, baselineColor: '#205c90',textPosition: 'none'},
