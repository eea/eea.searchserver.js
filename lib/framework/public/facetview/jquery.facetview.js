...
/*            if (Object.keys(filteredRecords).length > fn_settings.size){
        ...
        var correctFacetRenderer = function(trees, options){
            ...
            if(trees !== undefined && options !== undefined){
                correctHistrogramFacetRenderer(trees, options);
            }
        };

        var correctHistrogramFacetRenderer = function(trees, options){
        ...
        var refreshHistogram = function(el, rel){
...
/*            if (options.no_results_message) {
            ...
            correctFacetRenderer(trees,options);
