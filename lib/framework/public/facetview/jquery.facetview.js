        ...
        var createfacetgeo = function (options){
                ...
                '<div class="clearfix">',
                    ...
                    '<div id="geo-facet-tabs_'+rel+'">',
                        ...
                        '<div id="geo-accordion">',
                            '<div id="distance_fields">Distance fields</div>',
                            '<div>',
                            ...
                            '</div>',
                            '<div id="bounding_fields">Bounding area fields</div>',
                            '<div>',
            ...
            if(gmaps_loaded) {
                ...
                function update_distance_fields(shape) {
                    ...
                    var distval = Math.round( distance_shape.getRadius() / 1000 );
                ...
                if (defaults === undefined) {
                    $('#switch_distance_' + rel + ' i').toggle();
                    $('#switch_distance_' + rel).click();
                } else {
                    if (defaults.type === "distance"){
                        $('#switch_distance_' + rel + ' i').toggle();
                        $('#switch_distance_' + rel).click();
                    } else {
                        $('#switch_bounding_' + rel + ' i').toggle();
                        $('#switch_bounding_' + rel).click();
                    }
                }
                ...
                $("#facetview_geoplaceholder_" + rel + " input", obj).change(function(){
                    ...
                    if ($('#distance_fields').hasClass('ui-state-active')) {
                        $('#switch_distance_' + rel).click();
                    }
                    if ($('#bounding_fields').hasClass('ui-state-active')) {
                        $('#switch_bounding_' + rel).click();
                    }
                });
