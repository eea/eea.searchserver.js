...
/*                    if ( options.enable_rangeselect ) {
                ...
                if (autocomplete){
                    autocomplete_html = '<div class="facetview_filter_typeahead"><div><input placeholder="' + autocomplete_placeholder + '" type="text" rel="' + prop +  '"/></div></div><div style="clear:both"></div>';
                }
