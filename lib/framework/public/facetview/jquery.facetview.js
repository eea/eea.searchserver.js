...
console.log(facet);
if (facet === 'http://www.eea.europa.eu/portal_types#topic'){
debugger;
}
if (facet === 'places'){
debugger;
...
/*                    if ( options.enable_rangeselect ) {
                ...
                if (allow_exact){
                    ...
                    exact_html = 
                        '<div class="exact_facet_helper">'+
                            ...
                            '<span class="checkbox facetview_exact_icon eea-icon ' + checked_class + '"></span>'+
            ...
            $('.facetview_exact_icon', obj).bind('click', function(){
                if ($(this).hasClass('eea-icon-check-square-o')){
                    $(this)
                        .removeClass('eea-icon-check-square-o')
                        .addClass('eea-icon-square-o')
                }
                else{
                    $(this)
                ...
                $(this).closest(".facetview_filter_options").find(".facetview_exact").trigger("click");
            });
...
*/
        if (options.facets.length > 0 || options.static_filters.length > 0) {
            thefacetview = [
                ...
                '</div>',
                '<div class="portalMessage warningMessage no-results-message"> Your search did not return any results. Try to adjust your filters or reset them. </div>',
