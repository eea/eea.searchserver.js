            ...
            $.ajax({
                ...
                success:function(d){
                    ...
                    for (var i = 0; i < options.facets.length; i++){
                        if ((options.facets[i].histogram_config !== undefined) && (options.facets[i].histogram_config !== null)){
                            var histogram_config = options.facets[i].histogram_config
                            var cbs_decimals = countDecimals(histogram_config.columns_bucketsize)
