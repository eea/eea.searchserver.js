...
*/
        ...
        function fillMissingValues(set, step, intervalInput, sliderInterval, groupedDataset) {
            ...
            while(i <= intervalRangeEnd){
                if( Number(i) === i && i % 1 !== 0) dec = 2;

                result.push(i.toFixed(dec));
                var t = i + sliderInterval;
                i = parseFloat(t.toFixed(2));

            }

            if(result[result.length-1] !== intervalRangeEnd.toFixed(dec) ){
                result.push(intervalRangeEnd);
            }
            ...
            svg.selectAll("rect")
                ...
                .append("rect")
                    ...
                    .attr("width", function(a, i){
                        if(i === 0 || i === (histoDataset.length - 1) ){
                    ...
                    .on("mouseover", function(d) {
                        ...
                        tooltip.html( function(){
                            ...
                            return "<p><strong>" + d.y + " - " + max + "</strong></p><p><span>Number: " + d.x + "</span></p>";
                        })
        ...
        function renderSliderHistogram(rel, event, step, dataset, groupedDataset, intervalInput, sliderInterval) {
            ...
            var rangeselect = [
                ...
                rel,
                '" style="margin-left:10px; margin-right:10px; float:left;border-bottom: 0;',
                'clear:none;" class="clearfix"> <span ',
                'class="facetview_lowrangeval_',
                rel,
