...
//                var set_max_I = set_max + intervalInput;
        ...
        function facetRangeHistogram(event,  step) {
            ...
            /*if($slider.length > 0){
                ...
                var valsGroup = groupDatasetByIntervalWithExtremes( createValuesObj(valsFromSession), intervalInput, histogram_config);
                var sliderV = fillMissingValuesWithExtremes(intervalInput, sliderInterval, valsGroup, valsFromSession, histogram_config);
