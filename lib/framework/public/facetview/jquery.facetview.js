...
*/
        ...
        function renderSliderHistogram(rel, event, step, dataset, groupedDataset, intervalInput, sliderInterval, histogram_config,
            ...
            if(rel == 7){
                console.log("################################################");
                if(fromR === undefined) fromR = false;
                console.log("rel: " + rel);
                console.log("fromR: event :" + fromR, event);
                console.log("fromR: step :" + fromR, step);
                console.log("fromR: dataset :" + fromR, dataset.length);
                console.log("fromR: groupedDataset :" + fromR, groupedDataset.length);
                console.log("################################################");
            }
