...
*/
        ...
        function groupDatasetByIntervalWithExtremes(set, intervalInput, histogram_config) {
            var set_min = histogram_config.columns_bucket_min !== null ? histogram_config.columns_bucket_min : set[0].x;
            var set_max = histogram_config.columns_bucket_max !== null ? histogram_config.columns_bucket_max : set[set.length-1].x;
        ...
        function fillMissingValuesWithExtremes(intervalInput, sliderInterval, groupedDataset, histogram_config){
            ...
            var col_min = histogram_config.columns_bucket_min !== null ? histogram_config.columns_bucket_min : gDataset[0].x;
            var col_max = histogram_config.columns_bucket_max !== null ? histogram_config.columns_bucket_max : gDataset[gDataset.length-1].x;
            ...
            var datasetG = ( histogram_config.columns_bucket_min !== null || histogram_config.columns_bucket_max !== null ) ?
                gDataset.filter(function (item, index) {
            ...
            var end = (maxArrG[maxArrG.length-1] + parseFloat(intervalInput)) ;
        ...
        function facetRangeHistogram(event,  step) {
            ...
            if(histogram_config.columns_bucket_min !== null || histogram_config.columns_bucket_max !== null){
        ...
        function renderHistogram(rel, dataset, intervalInput, event, sliderInterval) {
            ...
            var histoDataset = dataset.map(function(item) {
                return { x: item.y, y: item.x, from: item.from, to: item.to};
            });
            if( histoDataset[histoDataset.length - 1].x === 0 ){
                histoDataset.splice(-1,1);
            }
