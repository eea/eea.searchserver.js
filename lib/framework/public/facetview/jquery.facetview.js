...
var global_records_temp = false;  // placeholder
...
//                var set_max_I = set_max + intervalInput;
        ...
        function formatRecords(records, histogram_config){
            // Not sure why sometimes the records are lost. So we save them
            // and use when missing, to skip errors. (refs #107572)
            if(records !== undefined) {
                global_records_temp = records;
            } else {
                records = global_records_temp;
            }
