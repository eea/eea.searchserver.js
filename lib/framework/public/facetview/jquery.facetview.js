...
*/
        ...
        var facetrangehistogram = function(event) {
            ...
            var rangeselect = [
                ...
                rel,
                ' class="facetview_facetrange_histogram"></div>',
                '</div> </div>'
            ].join('');
            ...
            function startGoogleChart($elem, data){
                ...
                function drawChart() {
                    ...
                    var chart = new google.visualization.Histogram(document.getElementById("facetview_rangeplaceholder_" + rel));
...
/*            if (Object.keys(filteredRecords).length > fn_settings.size){
        ...
        var showresults = function(sdata) {
            ...
            for (var each = 0; each < options.facets.length; each++) {
                ...
                if ($.inArray(facet, options.rangefacets) !== -1 || $.inArray(facet, options.rangehistogramfacets) !== -1){
