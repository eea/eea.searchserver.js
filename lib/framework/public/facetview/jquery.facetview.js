...
*/
        ...
        if (options.facets.length > 0 || options.static_filters.length > 0) {
            thefacetview = [
                ...
                '</h2>',
                '</div>',
                '<a class="clear-all eea-icon eea-icon-eraser i18n-link" href="{{REFRESH}}"><span class="i18n" i18n-variable="Search_Reset_Filters_Link_Text" i18n-change="html">Reset filters</span></a>',
/* disable global exact search
                exact_all_html,*/
