...
function addExactOnCurrentFacets(){
    ...
    $(".facetview_selected:visible").each(function(){
        ...
        $('[id="' + group_id + '"]').find(".facetview_group_title").find("span").not('.i18n').text(" (Match: " + text +")").addClass("i18n").attr("i18n-variable", "App_Sentence(Match: " + text + ")").attr("i18n-change", "html");
    });
    if (hasExact){
