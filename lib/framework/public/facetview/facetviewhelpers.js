...
function display_results(display_fields, $results, widget_callback) {
    ...
    for (var i = 0; i < data.records.length; i++) {
        ...
        templateVariables.title = simpleValue(title);
        templateVariables.description = simpleValue(description);
        templateVariables.url = simpleValue(url);
        templateVariables.datestamp = simpleValue(datestamp);
