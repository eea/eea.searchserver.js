...
const index_bulk_from_endpoint = async(river_config, bulk) => {
    return new Promise(async (resolve, reject) => {
        ...
        console.log("Start read from sparql:", nicedate());
        let data = await get_bulk_from_endpoint(river_config, bulk);
        console.log("End read from sparql:", nicedate());
        console.log("Start prepare data:", nicedate());
        ...
        console.log("End prepare data:", nicedate());
