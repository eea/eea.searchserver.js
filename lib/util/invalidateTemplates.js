...
module.exports = function(callback) {
    ...
    function getExternalTemplate(options, fileName, tagName){
    ...
    function downloadExternalTemplates(){
        ...
        getExternalTemplate(head_options, headFile, 'head');
        ...
        getExternalTemplate(header_options, headerFile, 'body');
        ...
        getExternalTemplate(footer_options, footerFile, 'body');
    }
