...
module.exports = function(callback) {
    ...
    var head_request = https.request(head_options, function (res) {
        var data = '';
    ...
    var header_request = https.request(header_options, function (res) {
        var data = '';
        res.on('data', function (chunk) {
            data += chunk;
        });
    ...
    var footer_request = https.request(footer_options, function (res) {
        var data = '';
        res.on('data', function (chunk) {
            data += chunk;
        });
