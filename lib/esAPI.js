...
x = "asd, \"dsdf,ff\",ff";
console.log(parse(x, {delimiter:",", relax:true, quote:'"'}));
    var properties = analyzers.mappings.resources.properties;
...
/*                        console.log(field_name);
                        console.log(results.results.bindings[i][field_name].value);
                        console.log(pattern);
                        console.log(values);
        ...
        new esAPI(esoptions)
            ...
            .execute();
console.log(parse("asdf, fda, 'adf,ff'", ","));
