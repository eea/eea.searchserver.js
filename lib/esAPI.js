...
function indexWhenNoMoreOperations(opts){
    var offset = opts.counter - opts.bulk_size;
        ...
        .on('data', function (row) {
            ...
            if (counter === 0){
                ...
                if (counter % bulk_size === 0){
                    ...
                    indexWhenNoMoreOperations({esoptions:esoptions, index:elastic.real_index, es_type:elastic.type, bulk:rows_str, stream:stream, counter:counter, bulk_size:bulk_size});
                    rows_str = "";
                }
            }
